...
import type { CustomizationFontObject } from '@sogebot/backend/src/graphql/schema/customization/customizationFontObject';
...
const id = computed(() => props.id ? props.id as string : route.params.id);
